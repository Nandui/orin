    ...
    <section>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {cards.map((card, i) => (
          <div
            key={i}
            className="rounded-2xl bg-[#141417] p-4 ring-1 ring-white/5"
          >
            <span
              className="mb-2 inline-block rounded px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-widest"
              style={{ backgroundColor: 'rgba(47,107,255,0.15)', color: '#4d83ff' }}
            >
              {card.tag}
            </span>
            <h3 className="mb-1.5 text-sm font-semibold text-neutral-100">
              {card.title}
            </h3>
